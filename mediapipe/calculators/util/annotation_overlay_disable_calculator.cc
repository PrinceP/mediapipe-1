...
// Example config (CPU):
// node {
//   calculator: "AnnotationOverlayDisableCalculator"
...
// }
//
class AnnotationOverlayDisableCalculator : public CalculatorBase {
 public:
  AnnotationOverlayDisableCalculator() = default;
  ~AnnotationOverlayDisableCalculator() override = default;
...
REGISTER_CALCULATOR(AnnotationOverlayDisableCalculator);

::mediapipe::Status AnnotationOverlayDisableCalculator::GetContract(
...
::mediapipe::Status AnnotationOverlayDisableCalculator::Open(CalculatorContext* cc) {
...
::mediapipe::Status AnnotationOverlayDisableCalculator::Process(
...
::mediapipe::Status AnnotationOverlayDisableCalculator::Close(CalculatorContext* cc) {
#if !defined(MEDIAPIPE_DISABLE_GPU)
...
::mediapipe::Status AnnotationOverlayDisableCalculator::RenderToCpu(
...
::mediapipe::Status AnnotationOverlayDisableCalculator::RenderToGpu(
...
::mediapipe::Status AnnotationOverlayDisableCalculator::CreateRenderTargetCpu(
    CalculatorContext* cc, std::unique_ptr<cv::Mat>& image_mat,
    ImageFormat::Format* target_format) {
  if (image_frame_available_) {
    const auto& input_frame =
...
::mediapipe::Status AnnotationOverlayDisableCalculator::CreateRenderTargetGpu(
    CalculatorContext* cc, std::unique_ptr<cv::Mat>& image_mat) {
#if !defined(MEDIAPIPE_DISABLE_GPU)
  if (image_frame_available_) {
    const auto& input_frame =
...
::mediapipe::Status AnnotationOverlayDisableCalculator::GlRender(
    CalculatorContext* cc) {
#if !defined(MEDIAPIPE_DISABLE_GPU)
...
::mediapipe::Status AnnotationOverlayDisableCalculator::GlSetup(
    CalculatorContext* cc) {
#if !defined(MEDIAPIPE_DISABLE_GPU)
